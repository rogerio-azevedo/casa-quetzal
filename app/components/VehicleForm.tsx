...
export default function VehicleForm({ onSubmit }: VehicleFormProps) {
  ...
  return (
    <div className="w-full bg-white rounded-lg shadow-md p-3 md:p-6">
      <div className="space-y-3 md:space-y-4">
        <div>
          <label htmlFor="placa" className="block text-sm font-medium text-gray-700 mb-1 md:mb-2">
            Placa do Veículo *
          </label>
          <input
            id="placa"
        ...
        <div>
          <label htmlFor="condutor" className="block text-sm font-medium text-gray-700 mb-1 md:mb-2">
        ...
        <div className="grid grid-cols-2 gap-2 md:gap-4 pt-2 md:pt-4">
          <button
            ...
            className="py-3 md:py-4 bg-green-600 text-white text-sm md:text-base font-semibold rounded-lg hover:bg-green-700 transition-colors shadow-md active:scale-95 transform"
          >
            REGISTRAR ENTRADA
          </button>
          <button
            onClick={() => handleSubmit('saida')}
            className="py-3 md:py-4 bg-red-600 text-white text-sm md:text-base font-semibold rounded-lg hover:bg-red-700 transition-colors shadow-md active:scale-95 transform"
          >
            REGISTRAR SAÍDA
          </button>
        </div>
